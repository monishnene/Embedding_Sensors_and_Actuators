// ======================================================================
// DCBRUSHLESSMOTOR.v generated from TopDesign.cysch
// 10/22/2017 at 14:15
...
module CharLCD_v2_20_0 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("35f18323-c02a-46c4-8fda-b0f95cb56ca6/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module ADC_SAR_v3_0_1 (
	...
	cy_clock_v1_0
		#(.id("7df496c5-54f8-4a06-825f-086371d290e2/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module ADC_SAR_v3_0_5 (
	...
	cy_clock_v1_0
		#(.id("f64369bf-8dc8-499f-8c00-ac94e7f06411/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("625001562.503906"),
		  .is_direct(0),
...
module top ;
    ...
    cy_annotation_universal_v1_0 Res (
        .connect({
            Net_151,
            Net_6
        })
    );
    defparam Res.comp_name = "Resistor_v1_0";
    defparam Res.port_names = "T1, T2";
    defparam Res.width = 2;
	...
	wire [0:0] tmpOE__Pot_P6_5_net;
	wire [0:0] tmpFB_0__Pot_P6_5_net;
	wire [0:0] tmpIO_0__Pot_P6_5_net;
	wire [0:0] tmpINTERRUPT_0__Pot_P6_5_net;
	electrical [0:0] tmpSIOVREF__Pot_P6_5_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("77715107-f8d5-47e5-a629-0fb83101ac6b"),
		  ...
		  .input_buffer_sel(2'b00))
		Pot_P6_5
		 (.oe(tmpOE__Pot_P6_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pot_P6_5_net[0:0]}),
		  .analog({Net_21}),
		  .io({tmpIO_0__Pot_P6_5_net[0:0]}),
		  .siovref(tmpSIOVREF__Pot_P6_5_net),
		  .interrupt({tmpINTERRUPT_0__Pot_P6_5_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pot_P6_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("a744f24b-41fd-46a7-a262-e9711596dfa4"),
	...
	cy_clock_v1_0
		#(.id("2c352a66-7679-473e-9e1a-01b740bbf745"),
		  .source_clock_id(""),
		  .divisor(0),
	...
	wire [0:0] tmpOE__Enc_B_P0_2_net;
	wire [0:0] tmpIO_0__Enc_B_P0_2_net;
	wire [0:0] tmpINTERRUPT_0__Enc_B_P0_2_net;
	electrical [0:0] tmpSIOVREF__Enc_B_P0_2_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		Enc_B_P0_2
		 (.oe(tmpOE__Enc_B_P0_2_net),
		  .y({1'b0}),
		  .fb({Net_47}),
		  .io({tmpIO_0__Enc_B_P0_2_net[0:0]}),
		  .siovref(tmpSIOVREF__Enc_B_P0_2_net),
		  .interrupt({tmpINTERRUPT_0__Enc_B_P0_2_net[0:0]}),
		  .annotation({Net_46}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Enc_B_P0_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Enc_A_P0_1_net;
	wire [0:0] tmpIO_0__Enc_A_P0_1_net;
	wire [0:0] tmpINTERRUPT_0__Enc_A_P0_1_net;
	electrical [0:0] tmpSIOVREF__Enc_A_P0_1_net;

	cy_psoc3_pins_v1_10
		#(.id("79a24401-4599-4b34-93af-53e5a96b7af2"),
		  .drive_mode(3'b001),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Enc_A_P0_1
		 (.oe(tmpOE__Enc_A_P0_1_net),
		  .y({1'b0}),
		  .fb({Net_122}),
		  .io({tmpIO_0__Enc_A_P0_1_net[0:0]}),
		  .siovref(tmpSIOVREF__Enc_A_P0_1_net),
		  .interrupt({tmpINTERRUPT_0__Enc_A_P0_1_net[0:0]}),
		  .annotation({Net_45}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Enc_A_P0_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_clock_v1_0
		#(.id("9f40cb3b-7fc6-44b8-b0f1-b60e51c41664"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("41666666.6666667"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__FETDrain_P3_1_net;
	wire [0:0] tmpFB_0__FETDrain_P3_1_net;
	wire [0:0] tmpIO_0__FETDrain_P3_1_net;
	wire [0:0] tmpINTERRUPT_0__FETDrain_P3_1_net;
	electrical [0:0] tmpSIOVREF__FETDrain_P3_1_net;

	cy_psoc3_pins_v1_10
		#(.id("f47cc716-86a5-426c-bb15-d4d1f4cd7e04"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		FETDrain_P3_1
		 (.oe(tmpOE__FETDrain_P3_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__FETDrain_P3_1_net[0:0]}),
		  .analog({Net_143}),
		  .io({tmpIO_0__FETDrain_P3_1_net[0:0]}),
		  .siovref(tmpSIOVREF__FETDrain_P3_1_net),
		  .interrupt({tmpINTERRUPT_0__FETDrain_P3_1_net[0:0]}),
		  .annotation({Net_7}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__FETDrain_P3_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_0_0_net;
	wire [0:0] tmpFB_0__Pin_0_0_net;
	wire [0:0] tmpIO_0__Pin_0_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_0_0_net;
	electrical [0:0] tmpSIOVREF__Pin_0_0_net;

	cy_psoc3_pins_v1_10
		#(.id("5e530e8d-0195-4779-8ee8-c1e6a478a94f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_0_0
		 (.oe(tmpOE__Pin_0_0_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__Pin_0_0_net[0:0]}),
		  .io({tmpIO_0__Pin_0_0_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_0_0_net),
		  .interrupt({tmpINTERRUPT_0__Pin_0_0_net[0:0]}),
		  .annotation({Net_127}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__Pin_0_0_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_3_0_net;
	wire [0:0] tmpFB_0__Pin_3_0_net;
	wire [0:0] tmpIO_0__Pin_3_0_net;
	wire [0:0] tmpINTERRUPT_0__Pin_3_0_net;
	electrical [0:0] tmpSIOVREF__Pin_3_0_net;

	cy_psoc3_pins_v1_10
		#(.id("5dd699fe-4a2f-4cdf-b0d9-af249afcd5b2"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    cy_annotation_universal_v1_0 Res_1 (
        .connect({
            Net_8,
            Net_130
        })
    );
    defparam Res_1.comp_name = "Resistor_v1_0";
    defparam Res_1.port_names = "T1, T2";
    defparam Res_1.width = 2;
