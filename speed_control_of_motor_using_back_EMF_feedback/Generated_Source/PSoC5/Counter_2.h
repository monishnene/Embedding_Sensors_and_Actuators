 ...
 **************************************/
#define Counter_2_CAPTURE_MODE_CONF       1u
#define Counter_2_INIT_PERIOD_VALUE       65534u
...
#define Counter_2_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_2_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
        ((uint8)((uint8)1u << Counter_2_STATUS_CAPTURE_INT_EN_MASK_SHIFT)) | \
...
#define Counter_2_DEFAULT_COMPARE_MODE    1u
    ...
    #define Counter_2_DEFAULT_CAPTURE_MODE    ((uint8)((uint8)1u << Counter_2_CTRL_CAPMODE0_SHIFT))
#else    
    #define Counter_2_DEFAULT_CAPTURE_MODE    (1u )
