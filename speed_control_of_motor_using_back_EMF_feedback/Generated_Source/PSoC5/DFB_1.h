...
#define DFB_1_INIT_INTERRUPT_MODE    (0u)
#define DFB_1_INIT_DMA_MODE          (0u)
#define DFB_1_INIT_OUT1_SOURCE       (0u)
...
#define DFB_1_CSA_RAM_SIZE_CUR       (0x01u)
#define DFB_1_CSB_RAM_SIZE_CUR       (0x01u)
#define DFB_1_CFSM_RAM_SIZE_CUR      (0x02u)
...
typedef struct
{
    ...
    uint8  sr;
    uint8  sem;
    uint32 acu[DFB_1_ACU_RAM_SIZE_CUR];
} DFB_1_BACKUP_STRUCT;
