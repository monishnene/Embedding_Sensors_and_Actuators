...
module ADC_SAR_v3_0_0 (
	...
	cy_clock_v1_0
		#(.id("28083ecf-6878-42fb-9378-f17acecf478a/696a0979-21fc-4185-bf38-6c79febcde7a"),
		  .source_clock_id(""),
		  .divisor(0),
...
module CharLCD_v2_20_2 ;
	...
	cy_psoc3_pins_v1_10
		#(.id("707fb9fe-6fc5-480b-9944-2416fd034cd8/ed092b9b-d398-4703-be89-cebf998501f6"),
...
module top ;
	...
	wire [0:0] tmpOE__p6_5_net;
	wire [0:0] tmpFB_0__p6_5_net;
	wire [0:0] tmpIO_0__p6_5_net;
	wire [0:0] tmpINTERRUPT_0__p6_5_net;
	electrical [0:0] tmpSIOVREF__p6_5_net;
	...
	cy_psoc3_pins_v1_10
		...
		p6_5
		 (.oe(tmpOE__p6_5_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__p6_5_net[0:0]}),
		  .analog({Net_116}),
		  .io({tmpIO_0__p6_5_net[0:0]}),
		  .siovref(tmpSIOVREF__p6_5_net),
		  .interrupt({tmpINTERRUPT_0__p6_5_net[0:0]}),
		  .annotation({Net_7}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__p6_5_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	cy_psoc3_pins_v1_10
		#(.id("025b233e-f2f7-44eb-a398-cf5f61d31750"),
		  .drive_mode(3'b000),
		  .ibuf_enabled(1'b0),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
