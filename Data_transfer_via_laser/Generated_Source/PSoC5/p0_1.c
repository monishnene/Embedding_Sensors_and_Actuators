...
*
* \funcusage
*  \snippet p0_1_SUT.c usage_p0_1_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet p0_1_SUT.c usage_p0_1_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet p0_1_SUT.c usage_p0_1_Read  
*******************************************************************************/
...
* preferred p0_1_Read() API because the 
* p0_1_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet p0_1_SUT.c usage_p0_1_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: p0_1_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use p0_1_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - p0_1_0_INTR       (First pin in the list)
    *  - p0_1_1_INTR       (Second pin in the list)
    *  - ...
    *  - p0_1_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet p0_1_SUT.c usage_p0_1_SetInterruptMode
    *******************************************************************************/
    void p0_1_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & p0_1_0_INTR) != 0u) 
		{ 
			 p0_1_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet p0_1_SUT.c usage_p0_1_ClearInterrupt
    *******************************************************************************/
