...
*/
     ...
     * \brief Constants to be passed as "mode" parameter in the p0_5_SetDriveMode() function.
     *  @{
     */
...
/* Interrupt constants */
#if defined(p0_5__INTSTAT)
/**
* \addtogroup group_constants
* @{
*/
    /** \addtogroup intrMode Interrupt constants
     * \brief Constants to be passed as "mode" parameter in p0_5_SetInterruptMode() function.
     *  @{
     */
        #define p0_5_INTR_NONE      (uint16)(0x0000u)
        #define p0_5_INTR_RISING    (uint16)(0x0001u)
        #define p0_5_INTR_FALLING   (uint16)(0x0002u)
        #define p0_5_INTR_BOTH      (uint16)(0x0003u) 
    /** @} intrMode */
/** @} group_constants */

    #define p0_5_INTR_MASK      (0x01u) 
#endif /* (p0_5__INTSTAT) */
...
/* SIO registers */
#if defined(p0_5__SIO_CFG)
    #define p0_5_SIO_HYST_EN        (* (reg8 *) p0_5__SIO_HYST_EN)
    #define p0_5_SIO_REG_HIFREQ     (* (reg8 *) p0_5__SIO_REG_HIFREQ)
    #define p0_5_SIO_CFG            (* (reg8 *) p0_5__SIO_CFG)
    #define p0_5_SIO_DIFF           (* (reg8 *) p0_5__SIO_DIFF)
#endif /* (p0_5__SIO_CFG) */
...
/* Interrupt Registers */
	...
	#define p0_5_0_INTTYPE_REG 		(* (reg8 *) p0_5__0__INTTYPE)
#endif /* (p0_5__INTSTAT) */
